...
df1 <- read_delim("/home/adrien/databases/dn1a2-vocabulary.csv", col_names=TRUE,delim=";",quoted_na=FALSE,na=character())
...
df2 <- read_delim("/home/adrien/databases/dn2-vocabulary.csv", col_names=TRUE,delim=";",quoted_na=FALSE,na=character())
...
df3 <- read_delim("/home/adrien/databases/erpc-vocabulary.csv", col_names=TRUE,delim=";",quoted_na=FALSE,na=character())
